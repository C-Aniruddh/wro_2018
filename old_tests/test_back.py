...
while True:
    ...
    angle_4_old = angle_4
    angle_5_old = angle_5
    print("Old", angle_0_old, angle_1_old, angle_2_old, angle_3_old, angle_4_old, angle_5_old)
    ...
    angle_4 = int(input("Enter angle 4 : "))
    angle_5 = int(input("Enter angle 5 : "))
    ...
    actuate(range_4, 3)
    e = input("Enter any key to actuate channel 4 : ")
    actuate(range_5, 7)
    f = input("Enter any key to actuate channel 5 : ")
    actuate(range_6, 5)
