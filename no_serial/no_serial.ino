...
void LSA_Manager() {
  ...
  if (junction) {
    ...
    junctionManager();
    delay(100);
  } else if ((digitalRead(4) && digitalRead(5) && digitalRead(6) && digitalRead(7))) {
    Forward(28, 28);
  } else if ((digitalRead(3) && digitalRead(4) && digitalRead(5)) ||
             (digitalRead(2) && digitalRead(3) && digitalRead(4) && digitalRead(5))) {
    Left(32, 18);
  } else if ((digitalRead(7) && digitalRead(8) && digitalRead(9)) ||
